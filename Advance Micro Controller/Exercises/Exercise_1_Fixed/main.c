...
int main(void) {
    ...
    __delay_cycles(10000000);//500ms delay. And as it was already mentioned, there are some overheads, so, not quite exact.

    lcd_cursorBlink(1);//blink cursor

    __delay_cycles(40000000);//2000ms delay. And as it was already mentioned, there are some overheads, so, not quite exact.
