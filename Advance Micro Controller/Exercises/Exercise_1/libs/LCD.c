...
void lcd_init (void)
{
	...
	enableTrigger();
	__delay_cycles(5000);//5ms delay. And as it was already mentioned, there are some overheads, so, not quite exact.
...
void enableTrigger(void)
{
	...
	__delay_cycles(2);//2us delay. And as it was already mentioned, there are some overheads, so, not quite exact.
